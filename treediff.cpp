...
int rf_2(bp_support_pedro<> vec_1, bp_support_pedro<> vec_2, vector<int>& code, int current, int &rf_dist, vector<int> &clusters_1){
    int lcas, lcas_aux, x;
...
// with internal nodes
int rf(bp_support_pedro<> vec_1, bp_support_pedro<> vec_2, vector<int>& code, int current, int &rf_dist, vector<int> &clusters_1){
    int lcas, lcas_aux, x;
