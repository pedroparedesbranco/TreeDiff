...
/*! \file bp_support_g.hpp
    ...
    \author Simon Gog
*/
#ifndef INCLUDED_SDSL_BP_SUPPORT_GGG
#define INCLUDED_SDSL_BP_SUPPORT_GGG
...
template<class t_nnd = nearest_neighbour_dictionary<30>,
         ...
         class t_select_2 = select_support_mcl<0>,
         class t_rmq = range_maximum_support_sparse_table<>,
         uint32_t t_bs=840>
class bp_support_ggg
{
        static_assert(t_bs > 2, "bp_support_ggg: block size must be greater than 2.");
    public:
        typedef bit_vector::size_type size_type;
        typedef t_nnd                 nnd_type;
        typedef t_rank                rank_type;
        typedef t_select              select_type;
        typedef t_select_2             select_type_2;
    ...
    private:
        ...
        void copy(const bp_support_ggg& bp_support) {
            ...
            m_select_bp_2 = bp_support.m_select_bp_2;
            m_select_bp_2.set_vector(m_bp);
    ...
    public:
        ...
        const select_type_2& bp_select_2 = m_select_bp_2;

        //! Constructor
        explicit
        bp_support_ggg(const bit_vector* bp = nullptr) : m_bp(bp),
            m_size(bp==nullptr?0:bp->size()), m_blocks((m_size+t_bs-1)/t_bs) {
            if (bp == nullptr)
                return;
            util::init_support(m_rank_bp, bp);
            util::init_support(m_select_bp, bp);
            util::init_support(m_select_bp_2, bp);
        ...
        //! Copy constructor
        bp_support_ggg(const bp_support_ggg& bp_support) {
            copy(bp_support);
        }

        //! Move constructor
        bp_support_ggg(bp_support_ggg&& bp_support) {
            *this = std::move(bp_support);
        }

        //! Assignment operator
        bp_support_ggg& operator=(const bp_support_ggg& bp_support) {
            if (this != &bp_support) {
                copy(bp_support);
            }
            return *this;
        ...
        //! Assignment operator
        bp_support_ggg& operator=(bp_support_ggg&& bp_support) {
            if (this != &bp_support) {
                ...
                m_select_bp_2 = std::move(bp_support.m_select_bp_2);
                m_select_bp_2.set_vector(m_bp);
        ...
        void swap(bp_support_ggg& bp_support) {
            m_rank_bp.swap(bp_support.m_rank_bp);
            m_select_bp.swap(bp_support.m_select_bp);

            m_select_bp_2.swap(bp_support.m_select_bp_2);
        ...
        size_type select_0(size_type i)const {
            return m_select_bp_2(i);
        }

        size_type rank_0(int v){
            return v - this->rank(v);
        }
...
//                assert( l>1 ); // mi is at greater or equal than 1
        ...
        */
        ...
        //! Serializes the bp_support_ggg to a stream.
        /*!
        ...
        size_type serialize(std::ostream& out, structure_tree_node* v=nullptr, std::string name="")const {
            ...
            written_bytes += m_select_bp_2.serialize(out, child, "bp_select_2");
        ...
        //! Load the bp_support_ggg for a bit_vector v.
        /*!
